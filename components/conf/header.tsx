      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 ">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4 flex-1">
            <Image className=" flex-grow" src={GitTogether} width={208} height={108} alt="Logo gittogether" />
            {/*<Logo />*/}
          </div>
          ...
          {/*        className="font-medium text-primary-400  hover:text-primary-300 px-5 py-3 flex items-center transition duration-150 ease-in-out"*/}
          {/*      >*/}
          {/*        Register*/}
          {/*      </Link>*/}
          {/*    </li>*/}
          ...
          {/*    </li>*/}
          {/*    /!*<li>*!/*/}
          {/*    /!*  <Link href="/program" className="font-medium text-primary-400  hover:text-primary-300 px-5 py-3 flex items-center transition duration-150 ease-in-out">Program</Link>*!/*/}
          {/*    /!*</li>*!/*/}
          ...
          {/*    /!*</li>*!/*/}
          {/*    /!*<li>*!/*/}
          {/*    /!*  <Link href="https://docs.google.com/forms/d/e/1FAIpQLSdj9q7dyRh3D7ZzRExHLWRRkNPOnLnFfrbKqSwqH3Ur4HzP4g/viewform" className="btn-sm text-gray-200 bg-secondary-300  hover:font-semibold ml-3">*!/*/}
          ...
          <div className="header-btn-container flex-1 justify-end hidden lg:flex">
            ...
            <div data-aos="fade-up " data-aos-delay="400">
              <Link className="ml-3 btn border border-primary-400 rounded-md overflow-hidden p-2.5 border-opacity-40 hover:text-primary-300 w-full mb-4 sm:w-auto sm:mb-0" target="_blank" href="https://forms.gle/iwZRL4UD2Pw1redaA">Submit CFP
