    ...
    <>
      <div className="relative mt-20">
        <div className=" relative mt-2 mb-8 z-10 max-w-5xl mx-auto flex flex-col justify-center">
          <h3 className=" text-center h2 text-secondary-300">Thoughts from Our Community</h3>
          <div className="flex flex-row max-lg:flex-col mt-10">
            ...
            <div className="flex flex-col">
              ...
              <Tweet
                ...
                id={"AndooBomber"}
                post={
                  "https://x.com/AndooBomber/status/1747663021747691808?s=20"
                }
                content={
              ...
              <Tweet
                ...
                id={"__alter123"}
                post={
                  "https://x.com/__alter123/status/1731985031521014236?s=20"
                }
                content={
