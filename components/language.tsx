...
import Gorilla from "@/public/images/frameworks/gorilla.png";
...
import Mongo from "@/public/images/frameworks/mongo.png";
        ...
        <div className="py-12 md:py-20">
          ...
          {/* <div className="px-12 py-8 pt-20 mx-4 text-center md:mx-0 ">
                <div className="absolute top-0 -mt-8 transform -translate-x-1/2 left-1/2 ">
                  ...
                  <Image className="relative mt-16 " src={TestimonialImage} width={115} height={110} alt="Nutanix Testimonial" />
                </div>
