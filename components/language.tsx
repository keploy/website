    ...
    <section className="relative">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 pointer-events-none -mb-32" aria-hidden="true">
        <svg width="1760" height="518" viewBox="0 0 1760 518" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="illustration-03">
              <stop stopColor="#FFF" offset="0%" />
              <stop stopColor="#EAEAEA" offset="77.402%" />
              <stop stopColor="#DFDFDF" offset="100%" />
            </linearGradient>
          </defs>
          <g transform="translate(0 0)" fill="url(#illustration-03)" fillRule="evenodd">
            <circle cx="1630" cy="128" r="128" />
          </g>
          <g transform="translate(0 -3)" fill="url(#illustration-03)" fillRule="evenodd">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="relative flex overflow-x-auto no-scrollbar">
            <div className="py-12 animate-marquee whitespace-nowrap flex ">
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/apacheclient.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/chi.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/dynamo.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/echo.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/elastic.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/express.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/gin.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/googlemaps.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/gorilla.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/grpc.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/h2db.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/mariadb.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/mongo.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/nethttp.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/octokit.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/okhttp.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/oracledb.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/postgres.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/redis.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/s3.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/springboot.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/sql.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
              <span className="mx-4 flex-none">
                <img className="relative hover:scale-110 transition-transform" src="/images/frameworks/webgo.png" width={106} height={100} alt="Nutanix Testimonial" />
              </span>
            </div>
          </div>

          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center mt-10 mb-3 ">
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-4">
            ...
            {/* Item */}
            <div className="hover:scale-110 transition-transform flex items-center justify-center py-2 col-span-2 md:col-auto">
              <svg  className="max-w-full" xmlns="http://www.w3.org/2000/svg" width="150" height="80" viewBox="0 0 150 70">
            ...
            {/* Item */}
            <div className="hover:scale-110 transition-transform flex items-center justify-center py-2 col-span-2 md:col-auto">
              <svg xmlns="http://www.w3.org/2000/svg" className="max-w-full" viewBox="0 0 150 75" width="161" height="80" preserveAspectRatio="xMidYMid">
          ...
          {/* <div className="max-w-3xl mx-auto mt-20 " data-aos="zoom-y-out">
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-gradient-to-r from-neutral-100 to-neutral-300 rounded-lg transition duration-300 hover:shadow-xl"> */}
              ...
              {/* <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0 ">
                ...
                <cite className="block font-bold text-lg not-italic mb-1 text-primary-300">Staff Engineer</cite>
