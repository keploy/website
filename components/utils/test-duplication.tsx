...
export const featuresData = [
    {
      title: 'Manual Testcase Verification',
      icon:<DependencyWaitTimeIcon />,
      description: 'Removes the laborious task of manually checking testcases, saving significant time and effort in the testing process.'
    },
    {
