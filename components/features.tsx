...
//             <div
//               className="flex items-center detail  dark:text-blue-500"
...
const TextSection = ({
  ...
  return (
    <div className="flex flex-col items-center pl-4 mt-6 mb-8 text-center md:block md:mb-0 h-min md:text-left md:mt-0 text-details">
      ...
      <div className="mb-1 text-2xl font-bold leading-snug tracking-tight md:text-4xl text-secondary-300 dark:text-blue-500">
        {heading}
      </div>
      <div className="text-gray-600 dark:text-gray-100 md:text-lg">{description}</div>
      {btnDescription && (
        <div>
          <Link
            className="btn mt-8 text-secondary-300 bg-primary-300 hover:text-white w-full mb-4 sm:w-auto sm:mb-0"
