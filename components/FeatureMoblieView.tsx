...
import testAndStubsGen from "@/public/images/testAndStubsGen.json"
import CaptureAndReplay from "@/public/images/CaptureAndReplayV2.json"
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center">
                      <div>
                        ...
                        <div className="text-gray-600">
                          ...
                          mocks and stubs. It's like a time machine for tests!
                        </div>
                      </div>
                    ...
                    <div>
                      <Link
                        ...
                        href="https://keploy.io/docs/keploy-explained/introduction/"
                      >
                        Explore More
                      </Link>
                    </div>
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center">
                      <div>
                        ...
                        <div className="text-gray-600">
                          Find redundant tests that don't add to the test
                    ...
                    <div>
                      <Link
                        className="btn mt-4 text-secondary-300 bg-primary-300 hover:text-white w-full mb-4 sm:w-auto sm:mb-0"
                        href="https://keploy.io/docs/keploy-cloud/deduplication/"
                      >
                        Explore More
                      </Link>
                    </div>
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <div>
                      <Link
                        className="btn mt-4 text-secondary-300 bg-primary-300 hover:text-white w-full mb-4 sm:w-auto sm:mb-0"
                        href="https://keploy.io/docs/server/sdk-installation/go/"
                      >
                        Explore More
                      </Link>
                    </div>
              ...
              <div className="transition-all">
                ...
                >
                  ...
                  <Transition
                    ...
                    beforeEnter={() => heightFix()}
                  >
                    <LottiePlayer VideoPath={CaptureAndReplay}/>
                  </Transition>
                  <Transition
                    show={tab === 3}
                    className="w-full"
