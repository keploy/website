...
export default function CustomForm({ isOpen, onClose }: FormProps) {
  ...
  const scriptUrl =
    "https://script.google.com/macros/s/AKfycbydZo0dyunlQ2v1qR9UgeeuDinOcPN70OBbu1vIiciOlo-vnstiWxfr49gZEkN5xQtxAA/exec";
    ...
    <>
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-filter backdrop-blur-lg flex justify-center items-center ">
          <div className="flex flex-col bg-neutral-100 rounded-lg p-8 w-full max-w-md mx-auto shadow-md border-b-primary-300 border-b-2">
            <div
