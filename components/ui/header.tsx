...
export default function Header() {
  ...
  return (
    <div className="flex justify-center w-full">
      <header
        className={`fixed  z-30 bg-neutral-100 transition duration-300 ease-in-out ${
          !top
            ? "bg-neutral-100 backdrop-blur-sm shadow-lg rounded-full top-3"
            : ""
        }`}
      >
        <div className="max-w-6xl mx-auto px-5 sm:px-6">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="header-btn-container flex-grow-0 w-4/12 justify-end items-center hidden lg:flex">
              <div
                className={`border border-primary-400  overflow-hidden p-2.5 border-opacity-40 relative transition-all  group
            ${!top ? " rounded-full" : "rounded-md"}`}
              >
                {/* Sliding effect span */}
