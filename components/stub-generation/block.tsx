      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-6 md:pb-10">
            <h1 className="h1 mb-4 text-secondary-300">Smart generation - Enhanced development</h1>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none ">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight text-accent-200 mb-1">Faster Development and Testing</h4>
              <p className="text-gray-600 text-center">Enables teams to validate components without waiting for the entire system to be implemented.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight text-accent-200 mb-1">Isolation of Components</h4>
              <p className="text-gray-600 text-center">Ensure that each part of the system can be tested without relying on the complete system.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl text-center font-bold leading-snug tracking-tight text-accent-200 mb-1">Improved Collaboration</h4>
              <p className="text-gray-600 text-center">Promotes collaboration between teams by allowing them to work independently on different components.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight text-accent-200 mb-1">Comprehensive Testing Scenarios</h4>
              <p className="text-gray-600 text-center">Simulate various scenarios helping testers assess different system responses and identify potential issues before deployment.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight text-accent-200 mb-1">Cost-Effectiveness</h4>
              <p className="text-gray-600 text-center"> Less time and effort required to create and maintain compared to fully functional services.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight text-accent-200 mb-1">Early Detection of Issues</h4>
              <p className="text-gray-600 text-center">Allows teams to identify and address problems in the early stages of development, reducing the likelihood of costly fixes later in the process.</p>
            </div>
          </div>
        </div>
      </div>
