...
import { BiMicrophone } from "react-icons/bi"; // Import from react-icons/bi
import { MdAutorenew, MdScience, MdComputer } from "react-icons/md"; // Import from react-icons/md
...
function getIconHelper() {
  ...
  cache.set("record", <BiMicrophone color="#5656e6" />);
  cache.set("test", <MdScience color="#5656e6" />);
  cache.set("replay", <MdAutorenew color="#5656e6" />);
  cache.set("terminal", <MdComputer color="#5656e6" />);
