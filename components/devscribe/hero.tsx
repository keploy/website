import VideoThumb from '@/public/images/conf/devscribe.png'
import ModalVideo from '@/components/devscribe/modal-video'
  ...
  return (
    <section>
      <div className=" max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="absolute left-0 bottom-0 -ml-20  lg:block pointer-events-none" aria-hidden="true" data-aos="fade-up" data-aos-delay="400">
          <svg className="max-w-full" width="1264" height="952" viewBox="0 0 564 552" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="illustration-02" x1="-3.766" y1="300.204" x2="284.352" y2="577.921" gradientUnits="userSpaceOnUse">
                <stop stopColor="#C14936" stopOpacity=".01" />
                <stop offset="1" stopColor="#C14936" stopOpacity=".32" />
              </linearGradient>
            </defs>
        ...
        <div className="relative pt-32 pb-10 md:pt-56 md:pb-16">
          ...
          <ModalVideo
              ...
              video="https://youtu.be/gvWvpqWM48s?si=sdyPBV781_hdyV9z"
              videoWidth={1920}
              videoHeight={1080} />
          {/* Section header */}
          <div className="max-w-6xl mx-auto text-center pb-12 md:pb-16">
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              ...
              <div data-aos="fade-up " data-aos-delay="400">
                <Link className="btn rounded-lg text-white bg-secondary-300 hover:text-primary-300 w-full mb-4 sm:w-auto sm:mb-0" target="_blank" href="https://forms.gle/X1XQkbZy9AaARHeZ9">Register
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <Link className="btn rounded-lg text-white border-primary-400 border-1 bg-transparent hover:text-primary-300 w-full sm:w-auto sm:ml-4" target="_blank"  href="https://forms.gle/1GapWjqvTr82NHbr5">Submit CFP</Link>
              </div>
            </div>
