        ...
        <div className="py-12 md:py-20 border-t border-gray-800 ">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-400">
              Please reach out to if you need to register as a Sponsor, email us
              - devrel[at]keploy[dot]io
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-1 lg:grid-cols-3 lg:gap-3 items-start lg:max-w-none py-6 md:py-10 ">
            <div
              className="flex flex-col h-full p-3 justify-center "
              data-aos="fade-up"
            >
              <div>
                <div className="relative inline-flex flex-col mb-4 max-h-fit ">
                  <Link
                    href="https://www.meetup.com/ministry-of-testing-bengaluru/"
                    title="Go to MoT"
                    target="_blank"
                    rel="noopener"
                  >
            ...
            >
              <div>
                <div className="relative inline-flex flex-col mb-4  justify-center">
                  <Link
                    href="https://community.cncf.io/noida/"
                    title="Go to CNCG Noida"
                    target="_blank"
                    rel="noopener"
                  >
                    <Image
            ...
            <div
              className="flex flex-col h-full p-12 justify-center "
              data-aos="fade-up"
            >
              <div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            {/* 1st testimonial */}
            <div
              className="flex flex-col flex flex-grow h-full p-6 "
              data-aos="fade-up"
            >
              <div>
                <div className="flex ">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700 text-center">
                <cite className="text-gray-200 not-italic">Neha Gupta</cite>{" "}
                <br />
                <Link
                  className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  target="_blank"
                  href="https://www.linkedin.com/in/neha-gup/"
                >
                  {" "}
                  Co-Founder, Keploy
                </Link>
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700 text-center">
                <cite className="text-gray-200 not-italic">Khushboo Verma</cite>{" "}
                <br />
                <Link
                  className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  target="_blank"
                  href="https://www.linkedin.com/in/verma-khushboo"
                >
                  {" "}
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700 text-center">
                <cite className="text-gray-200 not-italic">Hrittik Roy</cite>{" "}
                <br />
                <Link
                  className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  target="_blank"
                  href="https://www.linkedin.com/in/hrittikhere"
                >
                  {" "}
                  Platform Advocate at LoftLabs
                </Link>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700 text-center">
                <cite className="text-gray-200 not-italic">Sparsh Kesari</cite>{" "}
                <br />
                <Link
                  className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  target="_blank"
                  href="https://www.linkedin.com/in/sparshk98/"
                >
                  {" "}
                  Senior DevRel, LambdaTest
                </Link>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700 text-center">
                ...
                <Link
                  className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  target="_blank"
                  href="https://www.linkedin.com/in/abhakare/"
                >
                  {" "}
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700 text-center">
                <cite className="text-gray-200 not-italic">Balasundaram</cite>{" "}
                <br />
                <Link
                  className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  target="_blank"
                  href="https://x.com/balaintwt"
                >
            ...
            >
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700 text-center">
                <cite className="text-gray-200 not-italic">Gourav Kumar</cite>{" "}
                <br />
                <Link
                  className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  target="_blank"
                  href="https://www.linkedin.com/in/gourav-kumar-b20108173/"
                >
                  Senior Software Engineer, Keploy
                </Link>
              </div>
            </div>
