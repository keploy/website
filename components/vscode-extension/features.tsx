...
import Pic2 from "@/public/images/pic3.svg";
import Pic3 from "@/public/images/pic3.svg";
import Pic4 from "@/public/images/pic4.svg";
import ThirdImage from "@/public/images/thirdimage.png"; // Add path to the third image
    ...
    return (
        <div className="inline-flex flex-col w-full imageToShow" id="img-1">
            <div className="mb-2 h-[50%] py-2">
                <img src={Pic1.src} alt="Goodbye Image" className="w-full h-full object-cover rounded" />
            </div>
        </div>
    );
};
...
const TestDuplicationImage = () => {
    return (
        <div className="inline-flex flex-col w-full imageToShow">
        <div className="mb-2 h-[50%] py-2" id="img-2">
            <img src={Pic4.src} alt="Another Image" className="w-full h-[60vh] object-cover rounded" />
        </div>
        </div>
    );
};
...
const AdditionalImage = () => {
    return (
        <div className="inline-flex flex-col w-full imageToShow">
        <div className="mb-2 h-[50%] py-2" id="img-3">
            <img src={Pic3.src} alt="Third Image" className="w-full h-[60vh] object-cover rounded" />
        </div>
        </div>
    );
};
