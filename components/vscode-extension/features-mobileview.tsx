                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <div className="mb-1 font-bold leading-snug tracking-tight text-secondary-300 ">
                                                    Generate Tests with a Click
                                                </div>
                                                <div className="text-gray-600">
                                                    With one click, Keploy’s VS Code extension automatically analyzes code functions and generates well-structured unit tests. Save time on test creation and ensure code is covered effectively.
                                                </div>
                                            </div>
                                ...
                                >
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <div className="mb-1 font-bold leading-snug tracking-tight text-secondary-300">
                                                    Replay and Validate Code Changes Instantly
                                                </div>
                                                <div className="text-gray-600">
                                                    Keploy enables developers to replay tests with each code change to ensure stability. Quickly verify that new updates don’t introduce regressions or break existing functionality.
                                                </div>
                                            </div>
                                            <div className="flex items-center justify-center flex-shrink-0 w-8 h-8 ml-3 bg-white rounded-full shadow">
                                                <svg
                                        ...
                                        <div>
                                            <Link className="btn mt-4 text-secondary-300 bg-primary-300 hover:text-white w-full mb-4 sm:w-auto sm:mb-0" href="https://marketplace.visualstudio.com/items?itemName=Keploy.keployio">Explore VS Code Extension</Link>
                                        </div>
                                    </div>
                                </Link>
                                <Link
                                ...
                                >
                                    <div className="flex flex-col">
                                        <div className="flex items-center">
                                            <div>
                                                <div className="mb-1 font-bold leading-snug tracking-tight text-secondary-300">
                                                    Real-Time Code Coverage Insights
                                                </div>
                                                <div className="text-gray-600">
                                                    Keploy’s extension highlights untested code in real-time, helping developers keep track of their coverage metrics and identify gaps while they code.
