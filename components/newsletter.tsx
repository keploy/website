                  ...
                  {!subscribed && (
                    <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                      <input
                        ...
                        type="email"
                        className="form-input w-full appearance-none bg-neutral-100 border border-secondary-500 focus:border-secondary-400 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-secondary-300 placeholder-secondary-100"
